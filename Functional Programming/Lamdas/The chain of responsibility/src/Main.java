...
class ChainOfResponsibilityDemo {
    ...
    interface RequestHandler {
        ...
        default RequestHandler combine(RequestHandler requestHandler) {
            return r -> requestHandler.handle(handle(r));
        };
    }
    ...
    final static RequestHandler commonRequestHandler =
            wrapInTransactionTag.combine(createDigest.combine(wrapInRequestTag));
//            req -> wrapInRequestTag.combine(createDigest.combine(wrapInTransactionTag));
