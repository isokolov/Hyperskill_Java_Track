class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        burgerFactory.orderBurger("Chinese Burger");
        burgerFactory.orderBurger("American Burger");
        burgerFactory.orderBurger("Russian Burger");
    }
}
...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            case "Chinese Burger": /* write your code here */
                return new ChineseBurger("Chinese Burger");
            case "American Burger":/* write your code here */
                return new AmericanBurger("American Burger");
            case "Russian Burger":/* write your code here */
