class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        phone = samsungFactory.createPhone();  /* write your code here */
        ...
        phone = iphoneFactory.createPhone();  /* write your code here */
        System.out.println(phone.getDescription());
        System.out.println("There it is!");
    }
}
...
class IphoneFactory implements PhoneFactory {
    ...
    public Phone createPhone() {
        ...
        detailsFactory.createCamera();
        detailsFactory.createDisplay();
        detailsFactory.createProcessor();
        detailsFactory.createSecurity();
